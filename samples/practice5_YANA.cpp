...
int main(int argc, char** argv) {
	...
	for (;; )
	{
		...
		for (const auto& detection : tracker->trackedDetections())
		{
			...
			if (detection.classid == 12)
			{
				Mat dogs(frame, detection.rect);
				string modelPath = "C:/Users/яна/Desktop/streltsovayana/classification/squeezenet/1.1/caffe/squeezenet1.1.caffemodel";
				string configPath = "C:/Users/яна/Desktop/streltsovayana/classification/squeezenet/1.1/caffe/squeezenet1.1.prototxt";
				string labelPath = "C:/Users/яна/Desktop/streltsovayana/CV-SUMMER-CAMP/data/squeezenet1.1.labels";
				Classificator* a = new DnnClassificator(modelPath, configPath, labelPath, 300, 300, {0, 0, 0}, false);
				Mat prob = a->Classify(dogs);
				...
				string class_dogs;
				ifstream in("C:/Users/яна/Desktop/streltsovayana/CV-SUMMER-CAMP/data/squeezenet1.1.labels"); 
				if (in.is_open())
				{
					int index = -1;
					do
					{
						index++;
						if (index == classId - 1)
							getline(in, class_dogs);
					} while (!in.eof());
				}
				in.close(); 

				ofstream out;
				out.open("C:/Users/яна/Desktop/streltsovayana/Dogs.txt"); 
				if (out.is_open())
				{
					out << class_dogs << endl;
				}
